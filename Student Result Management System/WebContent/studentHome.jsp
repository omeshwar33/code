...
<%
try{
	String rollNo=request.getParameter("rollName");
	Connection con=ConnectionProvider.getCon();
	Statement st=con.createStatement();
	ResultSet rs=st.executeQuery("select * from student inner join where student.rollNo=result.rollNo and student.rollNo='"+rollNo+"'");
	if(rs.next()){
%>
<img src="logo.png"  align="left"width="150" height="150">
<center><img src="bhu.jpg" width="150" height="150">
<img src="apj sir.png" align="right"  width="150" height="150"></center>
    <a href="bhuOneView.html">Back</a>
  <hr class="new1">
<style>
table{
  width:100%;
...
Designed & Developed by Omeshwar</h6></center>
  <hr class="new1">
<center><h6>All Right Reserved @ Inventrix :: 2019-2021</h6></center> 
  <hr class="new1">
</body>
<%
	}
...
{
	response.sendRedirect("errorBhuOneView.html");
}
}
catch(Exception e)
{}
